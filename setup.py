...
setup(
    ...
    extras_require={
        ...
        'suite2p': ['suite2p@git+https://github.com/MouseLand/suite2p.git'], # TODO issue with current pypi version, github version works, change to pypi once issue is resolved and version lock
